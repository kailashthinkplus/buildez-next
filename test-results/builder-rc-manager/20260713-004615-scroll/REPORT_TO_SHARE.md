...
- Run directory: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-004615-scroll`
...
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-004615-scroll/cleanup-run-1.log`
...
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-004615-scroll/scroll-run-1.log`
...
Running 2 tests using 1 worker
  ...
  ✓  1 [setup] › playwright/tests/auth.setup.ts:7:6 › authenticate Builder RC user (1.9s)
  ✘  2 [builder-chromium] › playwright/tests/builder/operations/scroll-targeting.spec.ts:56:5 › @operations @scroll palette insertion targets the lower canvas after scrolling and survives reload (12.4s)
  ...
  1) [builder-chromium] › playwright/tests/builder/operations/scroll-targeting.spec.ts:56:5 › @operations @scroll palette insertion targets the lower canvas after scrolling and survives reload 
    ...
    Received: "rc-t3b-section-c"
    Timeout:  10000ms

    Call log:
      - Expect "toHaveAttribute" with timeout 10000ms
      - waiting for getByTestId('builder-shell')
        23 × locator resolved to <div data-dnd-valid="true" data-dnd-intent="inside" data-testid="builder-shell" data-builder-fullscreen="false" data-builder-focus-mode="false" data-dnd-over-id="rc-t3b-section-c" data-dnd-active-id="new:heading:7b28f673-c7e8-4eb2-a607-da9bd76c5c12" class="builder-shell h-screen w-full bg-[var(--dashboard-bg)] text-[var(--dashboard-text)] dark:bg-[#0F1118] dark:text-white overflow-hidden">…</div>
           - unexpected value "rc-t3b-section-c"


       at ../helpers/builderDrag.ts:392

      390 |   );
      391 |
    > 392 |   await expect(shell).toHaveAttribute(
          |                       ^
      393 |     "data-dnd-over-id",
      394 |     targetId,
      395 |   );
        at dragPaletteWidgetIntoVisibleTarget (/Users/kailash/buildez/apps/web-app/playwright/helpers/builderDrag.ts:392:23)
...
- Duration: 1.1s
- Command: `pnpm --dir /Users/kailash/buildez/apps/web-app test:builder:browser:operations:cleanup`
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-004615-scroll/cleanup-run-999.log`
