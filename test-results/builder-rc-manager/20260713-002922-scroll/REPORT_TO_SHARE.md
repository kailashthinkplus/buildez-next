...
- Run directory: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-002922-scroll`
...
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-002922-scroll/cleanup-run-1.log`
...
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-002922-scroll/scroll-run-1.log`

#### Log tail

```text
$ playwright test --project=builder-chromium --grep @scroll
SyntaxError: /Users/kailash/buildez/apps/web-app/playwright/tests/builder/operations/scroll-targeting.spec.ts: Unexpected token, expected "," (136:26)

  134 |
  135 |
> 136 |     await openBlocks(page);
      |                           ^
  137 |       );
  138 |
  139 |     await dragPaletteWidgetInside(page, "heading", target);

   at builder/operations/scroll-targeting.spec.ts:136
...
- Duration: 1.0s
- Command: `pnpm --dir /Users/kailash/buildez/apps/web-app test:builder:browser:operations:cleanup`
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-002922-scroll/cleanup-run-999.log`
