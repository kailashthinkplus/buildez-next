...
- Ticket: `baseline` — Current RC-T3 green baseline
- Run directory: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-000201-baseline`
...
Runs all currently implemented RC-T3 certification gates.
...
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-000201-baseline/cleanup-run-1.log`

### PASS — typecheck (run 1)

- Exit code: 0
- Duration: 3.8s
- Command: `pnpm --dir /Users/kailash/buildez/apps/web-app typecheck:builder`
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-000201-baseline/typecheck-run-1.log`

### PASS — rc-t3-node (run 1)

- Exit code: 0
- Duration: 2.6s
- Command: `pnpm --dir /Users/kailash/buildez/apps/web-app test:builder:rc-t3`
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-000201-baseline/rc-t3-node-run-1.log`

### PASS — operations-node (run 1)

- Exit code: 0
- Duration: 1.0s
- Command: `pnpm --dir /Users/kailash/buildez/apps/web-app test:builder:operations`
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-000201-baseline/operations-node-run-1.log`

### PASS — invalid-dnd (run 1)

- Exit code: 0
- Duration: 18.7s
- Command: `pnpm --dir /Users/kailash/buildez/apps/web-app test:builder:browser:operations:invalid`
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-000201-baseline/invalid-dnd-run-1.log`
...
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-000201-baseline/dnd-run-1.log`
...
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-000201-baseline/palette-run-1.log`

### PASS — reorder (run 1)

- Exit code: 0
- Duration: 7.2s
- Command: `pnpm --dir /Users/kailash/buildez/apps/web-app test:builder:browser:operations:reorder`
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-000201-baseline/reorder-run-1.log`

### PASS — keyboard (run 1)

- Exit code: 0
- Duration: 5.7s
- Command: `pnpm --dir /Users/kailash/buildez/apps/web-app test:builder:browser:operations:keyboard`
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-000201-baseline/keyboard-run-1.log`

### PASS — scoped-diff-check (run 1)

- Exit code: 0
- Duration: 0.1s
- Command: `git diff --check -- apps/web-app/modules/builder-v2 apps/web-app/playwright docs/builder docs/implementation docs/developer-logs`
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-000201-baseline/scoped-diff-check-run-1.log`
...
- Duration: 1.0s
- Command: `pnpm --dir /Users/kailash/buildez/apps/web-app test:builder:browser:operations:cleanup`
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-000201-baseline/cleanup-run-999.log`
...
```text
 ...
 67 files changed, 1677 insertions(+), 625 deletions(-)
