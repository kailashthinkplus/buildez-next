...
- Run directory: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-003311-scroll`
...
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-003311-scroll/cleanup-run-1.log`
...
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-003311-scroll/scroll-run-1.log`
...
Running 2 tests using 1 worker
  ...
  ✓  1 [setup] › playwright/tests/auth.setup.ts:7:6 › authenticate Builder RC user (2.0s)
  ✘  2 [builder-chromium] › playwright/tests/builder/operations/scroll-targeting.spec.ts:53:5 › @operations @scroll palette insertion targets the lower canvas after scrolling and survives reload (12.0s)


  1) [builder-chromium] › playwright/tests/builder/operations/scroll-targeting.spec.ts:53:5 › @operations @scroll palette insertion targets the lower canvas after scrolling and survives reload 
    ...
    > 141 |   await expect(source).toBeVisible();
      ...
      144 |   const targetBox = await target.boundingBox();
        ...
        at /Users/kailash/buildez/apps/web-app/playwright/tests/builder/operations/scroll-targeting.spec.ts:138:5
  ...
  1 failed
    [builder-chromium] › playwright/tests/builder/operations/scroll-targeting.spec.ts:53:5 › @operations @scroll palette insertion targets the lower canvas after scrolling and survives reload 
  1 passed (15.2s)
...
- Duration: 1.0s
- Command: `pnpm --dir /Users/kailash/buildez/apps/web-app test:builder:browser:operations:cleanup`
- Log: `/Users/kailash/buildez/test-results/builder-rc-manager/20260713-003311-scroll/cleanup-run-999.log`
