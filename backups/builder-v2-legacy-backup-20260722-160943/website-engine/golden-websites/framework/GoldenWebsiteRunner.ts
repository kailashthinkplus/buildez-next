...
export function goldenWebsiteInput(fixture: GoldenWebsiteCase): BuilderBlueprintInput {
  ...
  return {
    ...
    designResult: {
      ...
      typographyProfile: { headingFamily: language.name === "Luxury" || language.name === "Hospitality" ? "Georgia" : "Arial", bodyFamily: "Arial", scale: language.density, behavior: [] }, colorProfile: { paletteName: "golden", background: "#ffffff", foreground: "#171717", accent: "#315b52", muted: "#f2f2f0", behavior: [] },
...
export function runGoldenWebsite(fixture: GoldenWebsiteCase): GoldenWebsiteRun {
  ...
  return Object.freeze({ fixture, scores, validation, report, blueprint, creativeScore: semantic.creativeDirectionPlan.creativeScore, creativeWarnings: semantic.creativeDirectionPlan.creativeWarnings, creativeDirectionPlan: semantic.creativeDirectionPlan, determinismSignature, passed: validation.passed && scores.overallScore >= Math.max(minimum, fixture.expectedScores.overall) });
}
