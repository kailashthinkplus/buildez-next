...
import { dragPaletteWidgetIntoVisibleTarget } from "../../../helpers/builderDrag";
...
test(
  ...
  async ({ page }) => {
    ...
    await dragPaletteWidgetIntoVisibleTarget(page, "heading", target);
