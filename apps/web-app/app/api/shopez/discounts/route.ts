...
export async function POST(req: NextRequest) {
  ...
  const discount = await prisma.shopDiscount.create({ data: { shopId: access.shop.id, code: String(b.code).trim().toUpperCase(), type: b.type || "PERCENTAGE", value: money(b.value || 0), minimumAmount: b.minimumAmount ? money(b.minimumAmount) : null, usageLimit: b.usageLimit ? Number(b.usageLimit) : null, startsAt: b.startsAt ? new Date(b.startsAt) : undefined, endsAt: b.endsAt ? new Date(b.endsAt) : null, active: b.active !== false } });
