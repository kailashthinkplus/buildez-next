    ...
    <AuthSplitShell eyebrow="Start building" title="One account. Every ambition." description="Create for yourself or open a workspace for your business. Build Ezy adapts from the first step.">
      <div className="auth-card">
        ...
        <form onSubmit={signup}>
          ...
          <div className="auth-field"><label htmlFor="signup-email">Email address</label><input id="signup-email" type="email" autoComplete="email" placeholder="you@company.com" value={email} onChange={(event) => setEmail(event.target.value)} required /></div>
