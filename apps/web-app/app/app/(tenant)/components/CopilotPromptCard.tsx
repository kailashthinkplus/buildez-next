    ...
    <div className="dashboard-card relative mt-0 overflow-hidden rounded-2xl p-5 text-left sm:p-6">
      ...
      <div className="relative mt-4 rounded-2xl border dashboard-border bg-[var(--dashboard-surface-hover)] p-3">
        ...
        <div className="flex flex-wrap items-center gap-1.5 border-t dashboard-border pt-3">
          <Tool icon={Paperclip} label="Attach" />
          <Tool icon={ImageIcon} label="Create image" />
          <Tool icon={Search} label="Search web" />

          <button
            type="button"
            className="ml-auto flex h-8 w-8 items-center justify-center rounded-lg dashboard-hover dashboard-muted"
