...
export function NodeToolbar({ selection, onAction }: { selection: BuilderSelection; onAction(action: string): void }) {
  ...
  return <div role="toolbar" aria-label={`Actions for ${selection.tagName}`} className="absolute left-1/2 top-3 z-[160] flex -translate-x-1/2 items-center overflow-hidden rounded-lg border border-blue-300/30 bg-[#151923]/95 text-white shadow-2xl backdrop-blur-xl">
