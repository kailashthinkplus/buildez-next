...
export function buildDesignGraph(source: NormalizedTsx, budgets: Partial<EvaluationBudgets> = {}): DesignGraph {
  ...
  const page: DesignGraphNode = Object.freeze({
    ...
    layout: Object.freeze({ ...(interpreted.rootPresentation?.layout ?? {}) }),
    style: Object.freeze({ ...(interpreted.rootPresentation?.style ?? {}) }),
    responsive: Object.freeze({ ...(interpreted.rootPresentation?.responsive ?? {}) }),
