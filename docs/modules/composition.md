...
Composition rules are repository records selected by the Decision Engine and enforced by compiler/constraints. Simulation should evaluate composition risks such as three consecutive card grids, weak mobile CTA placement, and poor section density transitions.
