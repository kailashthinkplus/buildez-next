...
Knowledge should move into repository records and graph relationships. The knowledge module should not become a prompt bucket; it should provide typed records that constraints, reasoning, Decision Engine, compiler, critic, repair, and learning can consume.
