...
Repair consumes constraint violations, simulation issues, and critic findings. Structural repairs should patch Decision Plan choices or compiled plans before remapping rather than only editing rendered copy.
