...
Graph consumes repository records and exposes relationships for reasoning, Decision Engine, and compiler. It should support inheritance, compatibility, conflicts, required facts, required assets, and mapping hints across real estate, healthcare, restaurant, automotive, and education.
